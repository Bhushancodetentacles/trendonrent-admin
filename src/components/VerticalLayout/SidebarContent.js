      ...
      <SimpleBar className="h-100" ref={ref}>
        <div id="sidebar-menu">
          <ul className="metismenu list-unstyled" id="side-menu">
            ...
            <li>
              <Link to="/dashboard" id="dashboard_tab">
            ...
            <li >
              <Link to="/Rentdress" id="product_tab">
            ...
            <li>
              <Link to="/Customers" id="customer_tab">
            ...
            <li>
              <Link to="/Order" id="order_tab">
                <i className="bx bx-task"></i>
                <span>{props.t("Orders")}</span>
              </Link>
            </li>
            <li>
              <Link to="/calendar" id="calender_tab">
            ...
            <li>
              <Link to="/summary" id="loyality_tab" >
                <i className="bx bx-detail"></i>
                <span>{props.t("Loyalty")}</span>
              </Link>
            </li>
            <li>
              <Link to="/Category" id="category_tab">
