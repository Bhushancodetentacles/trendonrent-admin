...
export const deleteProductSuccess = orderId => ({
...
export const deleteCategorySuccess = orderId => ({
...
// LOYALTY
export const getLoyaltySuccess = loyalty => ({
  type: GET_LOYALTY_SUCCESS,
  payload: loyalty,
})

export const getLoyaltyFail = error => ({
  type: GET_LOYALTY_FAIL,
  payload: error,
})

export const addLoyaltySuccess = loyalty => ({
  type: ADD_LOYALTY_SUCCESS,
  payload: loyalty,
})

export const addLoyaltyFail = error => ({
  type: ADD_LOYALTY_FAIL,
  payload: error,
})
export const updateLoyaltySuccess = loyalty => ({
  type: UPDATE_LOYALTY_SUCCESS,
  payload: loyalty,
})

export const updateLoyaltyFail = error => ({
  type: UPDATE_LOYALTY_FAIL,
  payload: error,
})
